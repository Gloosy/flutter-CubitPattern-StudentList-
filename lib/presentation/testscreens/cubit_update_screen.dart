...
class _UpdateScreenState extends State<UpdateScreen> {
  ...
  void dispose() {
    ...
    focusNodefather!.dispose();
    focusNodemother!.dispose();
    focusNodeDOB!.dispose();
    focusNodeExam!.dispose();
  ...
  void initState() {
    super.initState();
    //SystemChannels.keyboard.addListner(_onKeyboardVisibilityChanged);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocBuilder<UpdateCubit, UpdateInfo>(builder: (context, state) {
    ...
    return ListView(
      children: [
        ...
        DOBAndExamDate(
          ...
          focusNodeDOB    : focusNodeDOB,
          focusNodeExam   : focusNodeExam,
          focusNodeName   : focusNodeName,
          focusNodefather : focusNodefather,
          focusNodemother : focusNodemother,
        ),
